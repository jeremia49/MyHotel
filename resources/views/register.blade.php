                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6 text-center mb-5">
                            <h2 class="heading-section">Daftar ke MyHotel</h2>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-7 col-lg-5">
                            <div class="wrap">
                              ...
                              <div class="d-flex">
                                ...
                                <form action="{{route('register.post')}}" method="POST" class="signin-form" autocomplete="off">
                                    @csrf
                          ...
                          <p class="text-center">Sudah memiliki akun? <a data-toggle="tab" href="{{route('login')}}">Login</a></p>
                        </div>
                      </div>
                        </div>
                    </div>
